...
export default function UserRegisterPage() {
  ...
  const { control, handleSubmit, setValue, formState: { errors } } = useForm({
    ...
    defaultValues: {
      ...
      password: "", confirmPassword: "", gender: "MALE" as const,
        ...
        >
          ...
          <View className="gap-6">
                        ...
                        <Controller
                          ...
                          render={({ field: mobileField }) => (
                            <CountryPhoneField
                              ...
                              countryCodeError={errors.mobileCountryCode?.message as string}
                              phoneError={errors.mobile?.message as string}
                            />
                          )}
                        />
                      )}
                ...
                <View key={field.name} className="space-y-1.5">
                  ...
                  <Controller
                    ...
                    render={({ field: { onChange, onBlur, value } }) => (
                      <TextInput
                        className={`${fieldClassName} pl-12 ${field.type === 'password' ? 'pr-12' : ''} ${errors[field.name as keyof typeof errors] ? errorFieldClassName : normalFieldClassName}`}
                        placeholder={field.placeholder}
                        placeholderTextColor="#94a3b8"
                        keyboardType={field.type === "password" ? "default" : (field.type as any) || "default"}
            ...
            <View className="space-y-1.5 mt-2">
              ...
              <View className="flex-row gap-3">
                {["MALE", "FEMALE", "OTHER"].map((gender) => (
                  <Pressable
                    key={gender}
                    onPress={() => setValue("gender", gender as "MALE" | "FEMALE" | "OTHER", { shouldValidate: true })}
            ...
            <View className="space-y-1.5">
              ...
              />
              {errors.currentAddress && <Text className="ml-1 mt-1 text-[10px] font-black uppercase text-red-500">{errors.currentAddress.message as string}</Text>}
            </View>
            ...
            <View className="space-y-1.5">
              ...
              />
              {errors.permanentAddress && <Text className="ml-1 mt-1 text-[10px] font-black uppercase text-red-500">{errors.permanentAddress.message as string}</Text>}
            </View>
