    ...
    <View className="flex-1 bg-slate-50 dark:bg-slate-950">
      ...
      <View className="px-5 pt-6 pb-6 bg-white dark:bg-[#020617] border-b border-slate-200 dark:border-slate-800">
        <View className="flex-row items-center justify-between mb-2">
          <Text className="text-2xl font-black tracking-tight text-slate-900 dark:text-white">Team Leader Teams</Text>
        </View>
...
function TeamCard({ team, index = 0 }) {
  ...
  return (
    <Animated.View entering={FadeInUp.duration(400).delay(index * 50).springify()}>
      <Pressable onPress={() => router.push(`/team-leader/team/${team.id}`)} className="p-5 mb-3 mx-4 bg-white dark:bg-slate-900 rounded-[24px] shadow-sm border border-slate-200 dark:border-slate-800 active:bg-slate-50 dark:active:bg-slate-800/80 active:scale-[0.98] transition-all">
