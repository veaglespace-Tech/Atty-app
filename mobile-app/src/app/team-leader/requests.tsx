  ...
  return (
    <View className="flex-1 bg-slate-50 dark:bg-slate-950">
      ...
      <View className="flex-1 items-center justify-center p-6">
        <ClipboardCheck size={64} className="text-slate-300 dark:text-slate-700 mb-6" />
        <Text className="text-xl font-black text-slate-900 dark:text-white text-center">Requests Coming Soon</Text>
