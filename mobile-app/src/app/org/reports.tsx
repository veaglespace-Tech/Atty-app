...
import { ChevronLeft, FileBarChart } from "lucide-react-native";
  ...
  return (
    <View className="flex-1 bg-slate-50 dark:bg-slate-950">
      ...
      <View className="flex-1 items-center justify-center p-6">
        <FileBarChart size={64} className="text-slate-300 dark:text-slate-700 mb-6" />
        <Text className="text-xl font-black text-slate-900 dark:text-white text-center">Reports Coming Soon</Text>
