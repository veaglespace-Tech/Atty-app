...
import { useGetMyAttendanceQuery, usePunchInMutation, usePunchOutMutation, useRequestRegularizationMutation } from "@/services/api/attendanceApi";
...
export default function OrgMyAttendancePage() {
  ...
  const summary = useMemo(() => Array.isArray(attendanceData?.summary) ? attendanceData.summary : [], [attendanceData]);
