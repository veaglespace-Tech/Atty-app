...
const MetricCard = ({ label, value, bgClass, textClass }) => (
  <View className={`flex-1 rounded-2xl p-4 border border-slate-100 dark:border-slate-800 ${bgClass} mb-2 mx-1`}>
    ...
    <View className="flex-1 bg-slate-50 dark:bg-slate-950">
      <View className="px-5 pt-12 pb-4 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800">
        <View className="flex-row items-center justify-between mb-2">
          ...
          <Text className="text-lg font-black tracking-tight text-slate-900 dark:text-white">Organization Attendance</Text>
          <View className="w-10" />
        </View>
