  ...
  return (
    <View className="flex-1 bg-slate-50 dark:bg-slate-950">
      ...
      <View className="flex-1 items-center justify-center p-6">
        <Bell size={64} className="text-slate-300 dark:text-slate-700 mb-6" />
        <Text className="text-xl font-black text-slate-900 dark:text-white text-center">Notifications Coming Soon</Text>
        <Text className="text-sm font-medium text-slate-500 dark:text-slate-400 text-center mt-2">
          Your organization alerts will appear here.
        </Text>
      </View>
    </View>
  );
