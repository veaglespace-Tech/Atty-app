  ...
  if (!Number.isFinite(userId) || userId <= 0) {
    return (
      <View className="flex-1 bg-slate-50 dark:bg-slate-950 items-center justify-center p-6">
        ...
        <Pressable onPress={() => router.back()} className="mt-4 bg-slate-200 dark:bg-slate-800 px-4 py-2 rounded-xl">
  ...
  if (!user) {
    return (
      <View className="flex-1 bg-slate-50 dark:bg-slate-950 items-center justify-center p-6">
        ...
        <Pressable onPress={() => router.back()} className="bg-slate-200 dark:bg-slate-800 px-4 py-2 rounded-xl">
          <Text className="font-bold text-slate-800 dark:text-slate-200">Go Back</Text>
        </Pressable>
      </View>
    );
