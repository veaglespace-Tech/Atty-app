    ...
    <View className="flex-1 bg-slate-50 dark:bg-slate-950">
      ...
      >
        {isLoading && leads.length === 0 ? (
          ...
          <View className="flex-1 items-center justify-center p-12 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800">
          ...
          <View className="space-y-4">
            ...
            {leads.map((lead) => (
              <View key={lead.id} className="bg-white dark:bg-slate-900 rounded-[24px] border border-slate-200 dark:border-slate-800 p-5">
