...
export default function SuperAdminDashboard() {
  ...
  const summary = useMemo(() => {
    ...
    const map = new Map();
    arr.forEach((item: any) => map.set(item.label, item.value));
    return map;
  }, [data]);
  ...
  return (
    ...
    >
      <View className="flex-row flex-wrap justify-between gap-y-3 mb-6">
        ...
        <View className="w-[48%] bg-blue-50 dark:bg-blue-500/10 p-4 rounded-[20px] border border-blue-100 dark:border-blue-800/50">
