...
export default function MobileDashboardShell({ children }) {
 ...
 <Pressable
 onPress={openDrawer}
 className="h-12 w-12 items-center justify-center rounded-full bg-slate-50 border border-slate-200 dark:bg-slate-900 dark:border-slate-800 ">
 ...
 className="flex-row items-center gap-2 bg-slate-50 dark:bg-slate-800 pl-1.5 pr-3 py-1.5 rounded-full border border-slate-200 dark:border-slate-700 "
 >
 {user?.avatar || user?.profilePicture ? (
 <Image source={{ uri: user.avatar || user.profilePicture }} style={{ width: 26, height: 26, borderRadius: 13 }} />
 ) : (
 <View className="h-[26px] w-[26px] items-center justify-center rounded-full bg-blue-100 dark:bg-blue-900">
 ...
 className="flex-row items-center justify-between p-3 rounded-2xl active:bg-blue-50 dark:active:bg-slate-800 ">
 ...
 <Pressable
 onPress={onLogout}
 className="flex-row items-center justify-center gap-2 py-3.5 bg-rose-50 dark:bg-rose-500 rounded-2xl border border-rose-100 dark:border-rose-500 active:opacity-70">
