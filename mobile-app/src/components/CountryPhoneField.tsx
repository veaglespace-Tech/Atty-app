...
export default function CountryPhoneField({
  ...
  return (
    <View className={containerClassName}>
      ...
      <View
        className={cn(
          "flex-row min-w-0 overflow-hidden rounded-[1.4rem] border-2 bg-white shadow-[0_16px_40px_rgba(15,23,42,0.08)] dark:bg-slate-950/88",
          hasError
      ...
      >
        ...
        <TextInput
          ...
          className="w-[3.5rem] sm:w-[4.5rem] border-r border-slate-200 bg-white px-2 py-3 text-xs font-semibold text-slate-900 sm:px-3 sm:py-4 sm:text-sm dark:border-slate-700 dark:bg-slate-950/88 dark:text-slate-100"
        />
        ...
        <TextInput
          ...
          placeholderTextColor="#94a3b8"
          className="flex-1 bg-white px-3 py-3 text-sm text-slate-900 sm:px-4 sm:py-4 dark:bg-slate-950/88 dark:text-slate-100"
        />
      </View>
