...
const buildUserAttendancePayload = async ({ userId, orgId, period, fromInput, toInput }) => {
  ...
  return {
    ...
    items: logs.map(log => ({
      ...
      reachedHomeAt: log.reachedHomeAt,
      reachedHomeLatitude: log.reachedHomeLatitude,
      reachedHomeLongitude: log.reachedHomeLongitude,
      reachedHomeLocationMeta: log.reachedHomeLocationMeta,
