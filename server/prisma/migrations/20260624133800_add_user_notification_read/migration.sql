...
-- AddForeignKey
ALTER TABLE `user_notification_read` ADD CONSTRAINT `user_notification_read_notificationId_fkey` FOREIGN KEY (`notificationId`) REFERENCES `post`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
