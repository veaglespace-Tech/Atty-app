                    ...
                    <div className="relative z-10">
                      ...
                      <div className="mb-4 flex items-end justify-between">
                        ...
                        <div className="text-right">
                          <span className={`text-3xl font-black tracking-tight ${theme.textMain}`}>{selectedPlan ? (Number(selectedPlan.price) === 0 ? "Free" : `Rs. ${Number(selectedPlan.price).toLocaleString("en-IN")}`) : "--"}</span>
                          {selectedPlan && Number(selectedPlan.price) !== 0 && (<span className={`mt-1 block text-xs font-medium ${theme.textSub}`}>/ lifetime or cycle</span>)}
                        </div>
                      </div>
