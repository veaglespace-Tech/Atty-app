...
import { useUserSignInMutation } from "@/store/api/authApi";
          ...
          <div className="p-7 sm:p-8 md:p-12">
            <div className="mb-10 text-center">
              ...
              <p className="font-medium tracking-wide text-slate-500 dark:text-slate-300">
                Securely manage your organization&apos;s workspace
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 sm:space-y-6">
              <div className="group relative">
                ...
                <p className="ml-1 mt-1.5 text-xs font-medium text-slate-400 dark:text-slate-500">
                  Choose the role assigned to your workspace account.
                </p>
                {errors.loginAs ? (
              ...
              <div className="group relative">
                <OrganizationLookupField
                  ...
                  helperText="Type your organization name, then select the correct workspace."
