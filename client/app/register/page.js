      ...
      <div className="relative z-10 mx-auto w-full max-w-5xl">
        ...
        >
          ...
          <h1 className="mb-4 text-5xl font-black leading-tight tracking-tight text-slate-950 dark:text-white md:text-7xl">
            Veagle <span className="gradient-text">Space</span>
          </h1>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:gap-10">
          <RegistrationCard
            ...
            desc="Register a new company to manage teams, attendance, reports, and workspace settings."
            badge="Owner / Admin"
            onClick={() => router.push("/register/organisation")}
          />

          <RegistrationCard
            icon={UserCircle2}
            title="Join as Member"
            desc="Onboard as an employee, team leader, or sub-admin inside an existing workspace."
            badge="Staff / Team"
        ...
        <motion.p
          ...
          className="mt-14 text-center text-[11px] font-bold uppercase tracking-widest text-slate-400 dark:text-slate-500"
        >
          Already part of the space?{" "}
          <button
...
function RegistrationCard({ icon: Icon, title, desc, badge, onClick }) {
  return (
    <motion.button
      type="button"
