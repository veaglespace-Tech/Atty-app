  ...
  return (
    <div className={`min-h-screen flex justify-center items-center relative overflow-hidden font-sans selection:bg-indigo-500/30 transition-colors duration-700 ${theme.bg}`}>
      ...
      <motion.div
        ...
        className="w-full max-w-6xl px-4 py-12 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center"
      >
        ...
        <div className="hidden lg:flex lg:col-span-5 flex-col justify-center gap-8 pl-4 lg:pl-8">
          ...
          <motion.div variants={containerVariants} className="space-y-6 mt-4">
            {[
              { icon: ShieldCheck, title: "Enterprise-grade Security", desc: "Your data is 100% encrypted & secure with us." },
        ...
        <motion.div
           ...
           className="lg:col-span-7 flex justify-center perspective-[1000px]"
        >
              ...
              {successState ? (
                ...
                <>
                  ...
                  <div className="space-y-6">
                    ...
                    {/* Badges footer */}
                    <div className="flex items-center justify-center gap-4 mt-6 transition-all duration-300 pointer-events-none opacity-40 dark:opacity-30 grayscale hover:grayscale-0">
                      <Image src="https://upload.wikimedia.org/wikipedia/commons/b/b5/PayPal.svg" alt="PayPal" width={60} height={20} className="h-5 w-auto" />
                      ...
                      <div className="w-px h-6 bg-slate-300 dark:bg-slate-700" />
                      <Image src="https://upload.wikimedia.org/wikipedia/commons/5/5e/Visa_Inc._logo.svg" alt="Visa" width={60} height={20} className="h-4 w-auto" />
                    </div>
                  </div>
                </>
              )}
