                ...
                <div key={item.id} className="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3">
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    <button
                      ...
                      disabled={busy}
                      className="inline-flex items-center gap-1 rounded-md border border-emerald-200 bg-emerald-50 px-3 py-1 text-xs font-semibold text-emerald-700 transition hover:bg-emerald-100 disabled:opacity-60"
                    >
                    ...
                    <button
                      ...
                      disabled={busy}
                      className="inline-flex items-center gap-1 rounded-md border border-rose-200 bg-rose-50 px-3 py-1 text-xs font-semibold text-rose-700 transition hover:bg-rose-100 disabled:opacity-60"
                    >
                      <XCircle size={14} />
                      Reject
                    </button>
