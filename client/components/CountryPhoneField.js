...
export default function CountryPhoneField({
  ...
  return (
    <div className={containerClassName}>
      ...
      >
        {Icon ? (
          <div className="pointer-events-none flex shrink-0 items-center justify-center border-r border-slate-200 px-3 text-slate-400 dark:border-slate-200">
        ...
        <select
          ...
          disabled={disabled}
          className={cn(
            "w-[5.25rem] shrink-0 border-r border-slate-200 bg-white px-2.5 py-3 text-xs font-semibold text-slate-900 outline-none sm:w-28 sm:px-3 sm:py-4 sm:text-sm dark:border-slate-200 dark:bg-white dark:text-slate-950",
            selectClassName
          )}
        >
        ...
        <input
          ...
          className={cn(
            "min-w-0 flex-1 bg-white px-3 py-3 text-sm text-slate-900 outline-none placeholder:text-slate-400 sm:px-4 sm:py-4 dark:bg-white dark:text-slate-950 dark:placeholder:text-slate-900",
            inputClassName
          )}
        />
      </div>
