...
const targetPath = path.join(__dirname, '../mobile-app/src/app/org/departments.jsx');

const newContent = `import React, { useState, useMemo, useEffect } from "react";
...
console.log('Successfully wrote new departments.jsx with full parity.');
